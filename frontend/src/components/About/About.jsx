import aboutImg from '../../assets/images/hero-img02.jpg'
      ...
      <div className="container">
        <div className="flex items-center justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
          ...
          <div className="relative w-3/4 lg:w-1/2 xl:w-[770px] z-10 prder-2 lg:order-1">
            <img src={aboutImg} alt="" className='w-[50%] aspect-square object-cover rounded-lg' />
            <div
              className="absolute z-20 bottom-4 w-[200px] md:w-[300px] md:right-[-7%] 
          lg:right-[22%]"
            >
          ...
          <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2 text-center">
            ...
            <p className="text__para">
              ...
              one of the best publics hospitals in the Nation and #1 in TN.
            </p>
